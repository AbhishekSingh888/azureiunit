...
public class T1_SUBTRACT {

	static String inputXMLFilePath = "testcases/ab.repository.imported.tests/T1_SUBTRACT.xml";
	String input;
	...
	public T1_SUBTRACT(String input, String expectedResult, String compareJson) {
		this.input = input;
	...
	public static Collection<String[]> testData() {
		return IUnitXMLParser.getParameters("resources/ab.repository.imported.tests/T1_SUBTRACT");
	}
}