...
public class TEST1_MULTIPLY {
	...
	static String inputXMLFilePath = "testcases/ab.repository.imported.tests/TEST1_MULTIPLY.xml";
	String input;
	...
	public TEST1_MULTIPLY(String input, String expectedResult, String compareJson) {
		this.input = input;
	...
	public static Collection<String[]> testData() {
		return IUnitXMLParser.getParameters("resources/ab.repository.imported.tests/TEST1_MULTIPLY");
	}
}