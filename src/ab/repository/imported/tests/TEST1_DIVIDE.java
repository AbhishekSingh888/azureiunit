...
public class TEST1_DIVIDE {

	static String inputXMLFilePath = "testcases/ab.repository.imported.tests/TEST1_DIVIDE.xml";
	String input;
	...
	public TEST1_DIVIDE(String input, String expectedResult, String compareJson) {
		this.input = input;
	...
	public static Collection<String[]> testData() {
		return IUnitXMLParser.getParameters("resources/ab.repository.imported.tests/TEST1_DIVIDE");
	}
}